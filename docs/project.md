...
- Servicos e agenda: agendamentos, disponibilidade, agenda da equipe.
...
O projeto usa Next.js 16, React 19, TypeScript strict, Prisma 7, PostgreSQL/Supabase, NextAuth, Tailwind CSS, Cloudflare R2, Resend, Melhor Envio, Mercado Pago e AbacatePay. Hoje a base concentra cerca de 40 models no Prisma, 81 rotas de API e 117 arquivos de teste.
